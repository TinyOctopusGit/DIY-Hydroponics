...
// Group
function editHome() {
  var div = document.getElementById("editHome");
...
function addBed() {
  var div = document.getElementById("addBed");
  if (div.style.display === "none") {
    div.style.display = "";
  } else {
    div.style.display = "none";
...
// Devices
function addDevice() {
  var div = document.getElementById("addDevice");
  if (div.style.display === "none") {
    div.style.display = "";
  } else {
    div.style.display = "none";
...
function addPump() {
  var div = document.getElementById("addPump");
  if (div.style.display === "none") {
    div.style.display = "";
  } else {
    div.style.display = "none";
